...
import org.unijorge.core.interfaces.Agua;
 ...
 public class Froakie extends Pokemon implements Agua{
  ...
  public Froakie(int idade, double peso, double tamanho, Sexo sexo, String nomeCientifico, int level, int levelProgress, int hp, Ataque atk, int def, int spd, int acuracia, int evasao){
